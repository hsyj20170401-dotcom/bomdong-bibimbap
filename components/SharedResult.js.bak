        ...
        <div style={{ width: 160, height: 115, margin: "0 auto 16px" }}>
          <svg viewBox="0 0 160 115" width="160" height="115">
            ...
            <g clipPath="url(#sClip)">
              {show("rice") && <ellipse cx="80" cy="72" rx="54" ry="20" fill="#fff8e8" stroke="#f0e6c8" strokeWidth="0.5" />}
              {show("bomdong") && <g><ellipse cx="62" cy="58" rx="20" ry="12" fill="#66BB6A" opacity="0.85" /><ellipse cx="98" cy="56" rx="17" ry="10" fill="#81C784" opacity="0.8" /><ellipse cx="80" cy="62" rx="14" ry="8" fill="#4CAF50" opacity="0.75" /></g>}
              {show("sauce") && <ellipse cx="80" cy="60" rx="16" ry="9" fill="#E53935" opacity="0.85" />}
              {show("gochugaru") && <g><circle cx="56" cy="60" r="2.5" fill="#FF5722" opacity="0.7" /><circle cx="66" cy="55" r="2" fill="#E64A19" opacity="0.6" /><circle cx="94" cy="58" r="2.5" fill="#FF5722" opacity="0.7" /><circle cx="104" cy="62" r="2" fill="#E64A19" opacity="0.6" /></g>}
              {show("egg") && <g><ellipse cx="80" cy="51" rx="14" ry="9" fill="#FFF9C4" /><circle cx="80" cy="50" r="6" fill="#FFD54F" /></g>}
              {show("oil") && <ellipse cx="80" cy="60" rx="24" ry="6" fill="rgba(255,193,7,0.2)" />}
              {show("anchovy") && <g><circle cx="50" cy="64" r="1.2" fill="#8D6E63" opacity="0.5" /><circle cx="110" cy="63" r="1.2" fill="#8D6E63" opacity="0.5" /></g>}
              {show("maesil") && <ellipse cx="80" cy="60" rx="22" ry="5" fill="rgba(139,195,74,0.15)" />}
              {show("soy") && <g><circle cx="72" cy="58" r="1.8" fill="#5D4037" opacity="0.3" /><circle cx="88" cy="59" r="1.8" fill="#5D4037" opacity="0.3" /></g>}
              {show("sesame") && <g><circle cx="68" cy="49" r="1.2" fill="#F5F5DC" /><circle cx="74" cy="47" r="1" fill="#F5F5DC" /><circle cx="86" cy="48" r="1.2" fill="#F5F5DC" /><circle cx="92" cy="50" r="1" fill="#F5F5DC" /><circle cx="80" cy="46" r="1" fill="#F5F5DC" /></g>}
            </g>
            <path d="M10,44 A70,20 0 0,0 150,44" fill="none" stroke="url(#sRim)" strokeWidth="4.5" />
          </svg>
        </div>
